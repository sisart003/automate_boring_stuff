...
# email, find this message, extract the link, and then launch qBittorrent to
# start downloading the file. This way, you can have your home computer
...
# Chapter 17 covers how to launch programs on your computer using the
...
# you. In particular, you might want to require that the emails contain a password, since it is fairly trivial for hackers to fake a “from” address in emails.
...
# Sending Email and Text Messages 445
...
# Chapter 11) to write a text file log that you can check if errors come up.
# qBittorrent (as well as other BitTorrent applications) has a feature
# where it can quit automatically after the download completes. Chapter 17
...
# from https://nostarch.com/automatestuff2/.